            ...
            if (G_count_352 < NTrades && MathAbs(Gd_412) >= Gd_308 + Gd_316 && GetTickCount() - Gi_260 >= 5000) {
               ...
               if (Gd_412 >= Gd_308) {
                  ...
                  if (ruka) {
                     ...
                     Print(G_symbol_600 + " buy at the price=" + G_ask_536 + " price Saxo bank=" + Gd_404 + " i=" + Gd_412 + " lot=" + NormalizeDouble(Lots, 2) + " spread Saxo bank=" +
                        NormalizeDouble(Gd_224, 1) + " ñïðåä ìò=" + NormalizeDouble(Gd_316, 2) + " ñòîï=" + price_12 + " òåéêîì=" + price_4);
                  }
                  if (G_ticket_344 > 0) {
               ...
               if (Gd_412 <= -Gd_308) {
                  ...
                  if (ruka) {
                     ...
                     Print(G_symbol_600 + " sell at the price=" + Gd_528 + " price Saxo bank=" + Gd_404 + " i=" + Gd_412 + " ëîòîì=" + NormalizeDouble(Lots, 2) + " spread Saxo bank=" +
                        NormalizeDouble(Gd_224, 1) + " ñïðåä ìò=" + NormalizeDouble(Gd_316, 2) + " ñòîï=" + price_12 + " òåéêîì=" + price_4);
                  }
                  if (G_ticket_344 > 0) {
   ...
   if (MathAbs(Gd_412) >= Gd_308 + Gd_316) {
      ...
      if (Gi_632) {
         Print("i=", Gd_412, " MinUr=", MinUr, " MinUrt=", Gd_308, "  Global=", Gd_404, "  Bid=", NormalizeDouble(Gd_528, Gi_328), "  Ask=", NormalizeDouble(G_ask_536, Gi_328),
            "  ", Gs_380, "  ñïðåä ñàêñû=", Gd_224, "  ñïðåä ìò=", Gd_316);
      }
...
int f0_10() {
   ...
   int Li_24;
   int Li_28 = 3000;
   Gi_508 = FindWindowA("#32770", "Îðäåð");
   if (Gi_508 != 0) {
